...
<head>
  ...
  <link href="{{ asset('frontendtemplate/vendor/fontawesome-free/css/all.min.css')}} ">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <!-- <a class="nav-link" href="{{route('cart')}}"><i class="far fa-shopping-cart"></i>Cart</a> -->
            <a class="nav-link" href="show_cart.php"><i class="fa fa-shopping-cart" style="font-size: 22px;"></i><span class="badge badge-light product_count">0</span></a>
